    ...
    <footer className="bg-[#f8f9fa] text-black">
      <div className="max-w-screen-xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="text-2xl font-black text-black tracking-tight mb-3">BEXO</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="/products" className="hover:text-black transition-colors">Browse Products</a></li>
              <li><a href="/requirements" className="hover:text-black transition-colors">Post Requirement</a></li>
              <li><a href="/auth/seller" className="hover:text-black transition-colors">Become a Seller</a></li>
              <li><a href="/seller/dashboard" className="hover:text-black transition-colors">Seller Dashboard</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="#" className="hover:text-black transition-colors">About Bexo</a></li>
